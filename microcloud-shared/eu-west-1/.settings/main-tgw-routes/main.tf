...
module "main_tgw_routes_shared" {
  ...
  static_routes = [
    { cidr = "10.18.0.0/16", attachment_id = var.vpc_tgw_attachment_id_shared },      # local
    { cidr = "10.16.0.0/16", attachment_id = var.tgw_peering_attachment_ue1_ew1_id }, # us-east-1 shared
    { cidr = "10.22.0.0/16", attachment_id = var.tgw_peering_attachment_ue1_ew1_id }, # us-east-1 nonprod
    { cidr = "10.28.0.0/16", attachment_id = var.tgw_peering_attachment_ue1_ew1_id }, # us-east-1 prod
  ]
}
...
module "main_tgw_routes_nonprod" {
  ...
  static_routes = [
    { cidr = "10.24.0.0/16", attachment_id = var.vpc_tgw_attachment_id_nonprod },     # local
    { cidr = "10.16.0.0/16", attachment_id = var.tgw_peering_attachment_ue1_ew1_id }, # us-east-1 shared
    { cidr = "10.22.0.0/16", attachment_id = var.tgw_peering_attachment_ue1_ew1_id }, # us-east-1 nonprod
  ]
}
...
module "main_tgw_routes_prod" {
  ...
  static_routes = [
    { cidr = "10.30.0.0/16", attachment_id = var.vpc_tgw_attachment_id_prod },        # local
    { cidr = "10.16.0.0/16", attachment_id = var.tgw_peering_attachment_ue1_ew1_id }, # us-east-1 shared
    { cidr = "10.28.0.0/16", attachment_id = var.tgw_peering_attachment_ue1_ew1_id }, # us-east-1 prod
  ]
}
...
module "main_tgw_routes_ue1_ew1" {
  ...
  # optional variables
  static_routes = [
    { cidr = "10.18.0.0/16", attachment_id = var.vpc_tgw_attachment_id_shared },      # eu-west-1 shared
    { cidr = "10.24.0.0/16", attachment_id = var.vpc_tgw_attachment_id_nonprod },     # eu-west-1 nonprod
    { cidr = "10.30.0.0/16", attachment_id = var.vpc_tgw_attachment_id_prod },        # eu-west-1 prod
    { cidr = "10.16.0.0/16", attachment_id = var.tgw_peering_attachment_ue1_ew1_id }, # us-east-1 shared
    { cidr = "10.22.0.0/16", attachment_id = var.tgw_peering_attachment_ue1_ew1_id }, # us-east-1 nonprod
    { cidr = "10.28.0.0/16", attachment_id = var.tgw_peering_attachment_ue1_ew1_id }, # us-east-1 prod
  ]
