...
dependency "vpc_endpoints" {
  config_path = "${get_path_to_repo_root()}/microcloud-shared/eu-west-1/.settings/vpc-endpoints"
...
inputs = {
  hosted_zone_id = dependency.route53_private_zone.outputs.ew1_shared_corp_microcloud_com_zone_id
