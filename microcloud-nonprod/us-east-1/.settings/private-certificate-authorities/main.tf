...
module "ue1_nonprod_vpn_private_ca" {
  source = "git::https://github.com/mateusz-uminski/terraform-service-modules//tls-certificate?ref=tls-certificate/v0.1.0"

  # required variables
  organization_name = "microcloud"
  domain_name       = "ue1.nonprod.vpn.microcloud.com"
...
output "ue1_nonprod_corp_private_ca" {
  value = {
    key   = module.ue1_nonprod_corp_private_ca.private_key_pem
    cert  = module.ue1_nonprod_corp_private_ca.locally_signed_cert_pem
    chain = module.ue1_nonprod_corp_private_ca.chain_pem
  }
  sensitive = true
}

output "ue1_nonprod_vpn_private_ca" {
  value = {
    key   = module.ue1_nonprod_vpn_private_ca.private_key_pem
    cert  = module.ue1_nonprod_vpn_private_ca.locally_signed_cert_pem
    chain = module.ue1_nonprod_vpn_private_ca.chain_pem
  }
  sensitive = true
}
