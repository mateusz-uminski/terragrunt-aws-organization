...
dependency "route53_private_zones" {
  ...
  mock_outputs = {
    ...
    ue1_dev_corp_microcloud_com_zone_id    = ""
    ew1_dev_corp_microcloud_com_zone_id    = ""
  }
}
...
inputs = {
  ...
  ue1_dev_corp_microcloud_com_zone_id    = dependency.route53_private_zones.outputs.ue1_dev_corp_microcloud_com_zone_id
  ew1_dev_corp_microcloud_com_zone_id    = dependency.route53_private_zones.outputs.ew1_dev_corp_microcloud_com_zone_id
