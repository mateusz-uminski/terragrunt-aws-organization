...
module "main_tgw_routes_ac_core_prod" {
  ...
  static_routes = [
    { cidr = "10.16.0.0/16", attachment_id = var.vpc_tgw_attachment_id_ac_core_prod },  # local
    { cidr = "10.18.0.0/16", attachment_id = var.tgw_peering_attachment_use1_euw1_id }, # eu-west-1 ac-core-prod
    { cidr = "10.24.0.0/16", attachment_id = var.tgw_peering_attachment_use1_euw1_id }, # eu-west-1 ac-app-dev
    { cidr = "10.30.0.0/16", attachment_id = var.tgw_peering_attachment_use1_euw1_id }, # eu-west-1 ac-app-prod
  ]
}
...
module "main_tgw_routes_ac_app_dev" {
  ...
  static_routes = [
    { cidr = "10.22.0.0/16", attachment_id = var.vpc_tgw_attachment_id_ac_app_dev },    # local
    { cidr = "10.18.0.0/16", attachment_id = var.tgw_peering_attachment_use1_euw1_id }, # eu-west-1 ac-core-prod
    { cidr = "10.24.0.0/16", attachment_id = var.tgw_peering_attachment_use1_euw1_id }, # eu-west-1 ac-app-dev
  ]
}
...
module "main_tgw_routes_ac_app_prod" {
  ...
  static_routes = [
    { cidr = "10.28.0.0/16", attachment_id = var.vpc_tgw_attachment_id_ac_app_prod },   # local
    { cidr = "10.18.0.0/16", attachment_id = var.tgw_peering_attachment_use1_euw1_id }, # eu-west-1 ac-core-prod
    { cidr = "10.30.0.0/16", attachment_id = var.tgw_peering_attachment_use1_euw1_id }, # eu-west-1 ac-app-prod
  ]
}
...
module "main_tgw_routes_use1_euw1" {
  ...
  # optional variables
  static_routes = [
    { cidr = "10.16.0.0/16", attachment_id = var.vpc_tgw_attachment_id_ac_core_prod },  # us-east-1 ac-core-prod
    { cidr = "10.22.0.0/16", attachment_id = var.vpc_tgw_attachment_id_ac_app_dev },    # us-east-1 ac-app-dev
    { cidr = "10.28.0.0/16", attachment_id = var.vpc_tgw_attachment_id_ac_app_prod },   # us-east-1 ac-app-prod
    { cidr = "10.18.0.0/16", attachment_id = var.tgw_peering_attachment_use1_euw1_id }, # eu-west-1 ac-core-prod
    { cidr = "10.24.0.0/16", attachment_id = var.tgw_peering_attachment_use1_euw1_id }, # eu-west-1 ac-app-dev
    { cidr = "10.30.0.0/16", attachment_id = var.tgw_peering_attachment_use1_euw1_id }, # eu-west-1 ac-app-prod
  ]
